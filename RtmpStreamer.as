...
public class RtmpStreamer1 extends MovieClip {
    ...
    public function RtmpStreamer1() {
		...
		ExternalInterface.addCallback("setMicSilent", setMicSilent);
	...
	public function setMicSilent(silent:int):void{
		_micSilent = silent;
	}
...
//            Mic
         ...
         */
        mic.rate = _micRate;
		mic.setSilenceLevel(_micSilent, 5);
